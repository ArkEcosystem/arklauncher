...
final class CollaboratorDeclinedInvite extends Notification
{
    use Queueable;
    ...
    public function toArray(): array
    {
        return (new NotificationBuilder())
            ->fromToken($this->token, [
                'content' => trans('notifications.subjects.collaborator_refused_invitation', ['collaborator' => $this->user->name]),
            ])

...
final class IndexServerProviderImagesFailed extends Notification
{
    use Queueable;
    ...
    public function toArray(): array
    {
        return (new NotificationBuilder())
            ->fromServerProvider($this->serverProvider, [
                    'content' => trans('notifications.subjects.server_provider_image_index_failed', ['serverProvider' => $this->serverProvider->name]),
                ])
            ->danger()
            ->getContent();
    }

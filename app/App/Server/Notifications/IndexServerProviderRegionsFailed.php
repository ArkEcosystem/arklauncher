...
final class IndexServerProviderRegionsFailed extends Notification
{
    use Queueable;
    ...
    public function toArray(): array
    {
        return (new NotificationBuilder())
            ->fromServerProvider($this->serverProvider, [
                'content' => trans('notifications.subjects.server_provider_region_index_failed', ['serverProvider' => $this->serverProvider->name]),
            ])
            ->danger()
            ->getContent();
    }

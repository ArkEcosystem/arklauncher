...
final class ProvisionExplorer implements Script
{
    use LocatesScript;
    ...
    {
        return trans('scripts.names.provision_explorer', ['server' => $this->server->name]);
    }

    public function script(): string
    {
        return View::make(
            $this->getScriptPath($this->token, 'provision-explorer'),

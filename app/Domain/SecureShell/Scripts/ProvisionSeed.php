...
final class ProvisionSeed implements Script
{
    use LocatesScript;
    ...
    {
        return trans('scripts.names.provision_seed', ['server' => $this->server->name]);
    }

    public function script(): string
    {
        return View::make(
            $this->getScriptPath($this->token, 'provision-seed'),

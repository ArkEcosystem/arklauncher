...
it('sends the notification to the user', function () {
    ...
    $serverProvider->token->user->notify(new ServerProviderSecureShellKeyAdditionFailed($serverProvider));
...
it('can determine if notification should be sent to a user', function () {
    ...
    $notification = new ServerProviderSecureShellKeyAdditionFailed($serverProvider);
...
it('should contain the type of the notification', function () {
    ...
    $notification = (new ServerProviderSecureShellKeyAdditionFailed($serverProvider))->toArray();
...
it('should contain the right content', function () {
    ...
    expect($notification['content'])->toBe(trans('notifications.subjects.server_provider_ssh_key_addition_failed', ['serverProvider' => $serverProvider->name]));
});
